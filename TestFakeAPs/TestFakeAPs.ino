...
const float tau = 0.05; // sec, decay time of the exponential
const float plateau = 0.01; // sec, time to keep the current at its plateau before exponential rise
const int cutoff = 750; // cutoff index of the negative current
...
void setup() {
  ...
  //skArray = fakeSK(0.03, 0.01, 0.02, amplitude, 13600);
  skArray = fakeSKExp(0.4,0.002, tau, amplitude, plateau, 13600);
  Serial.println("Ending");
  Serial.println(skArray[280]);
}
